...
ZorinMacBridge v0.6.7 does **not** require Developer ID, a self-signed certificate, a keychain identity, GitHub signing secrets, or signing setup on the Linux workstation.
